    ...
    : CaixaTextoBase
{
    ...
    private void Configure()
    {
        ...
        base.PermitirLetras = false;
        base.PermitirSimbolos = false;
    ...
    {
        if ( base.PlaceholderText.TemConteudo() )
            return;

        switch ( Mask )
        {
            case DateTimeMask.Short:
                base.PlaceholderText = "MM/YYYY";
                break;
            case DateTimeMask.Normal:
                base.PlaceholderText = "DD/MM/YYYY";
                break;
            case DateTimeMask.Long:
                base.PlaceholderText = "DD/MM/YYYY HH:MM:SS";
                break;
        }
    }
