namespace MyGears.Components.Datas.Base
{
    public class DataGridStyleBase : DataGridViewCellStyle
    {
        #region Propriedades
        ...
        protected DataGridStyleBase( Color corFundo, Color corFonte, Color corFundoSelecao, Color corFonteSelecao )
        {
            BackColor = corFundo;
            ForeColor = corFonte;
